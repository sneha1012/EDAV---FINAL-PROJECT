...
## ![Scatter Plot Analysis: Gender Distribution in Migration ](Graphs/Scatter.png)
...
## ![Bar Chart: Regional Distribution of Populations of Concern](Graphs/Bar.png)
...
## ![Choropleth Map: Global Distribution of Asylum Seekers](Graphs/Chloro.png)
...
## ![Ridgeline Plot: Normalized Refugee Numbers by Region](Graphs/Ridge.png)
...
## ![Boxplot: Distribution of International Migrant Stock](Graphs/Box.png)
...
## ![Histogram: Proportion of Migrants in Total Population](Graphs/Hist.png)
...
## ![Q-Q Plot: Distribution Analysis of Migrant Stock](Graphs/QQ.png)
...
## ![Scatter Plot: Migrant Stock vs. Refugee Population](Graphs/Scatterplot2.png)
...
## ![Parallel Coordinates Plot: Migration Metrics](Graphs/Parcoords.png)
...
## ![ Heatmap: Overview of Migration Metrics](Graphs/Heatmap.png)
